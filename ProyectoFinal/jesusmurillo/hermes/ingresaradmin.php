...
else
{
	...
	try
	{
		...
		$stmt = $dbh->prepare("SELECT id, usuario, password FROM admins 
...
<html>
	...
	<body>
		...
		<?php if($redirec == true){echo "<script>setTimeout(\"location.href = 'admin.php';\",1500);</script>";} else {echo "<script>setTimeout(\"location.href = 'adminlogin.php';\",1500);</script>";}?>
	</body>