<?php include "cabecera.php" ?>
      ...
      <div class="jumbotron" id ="div2">
		  ...
		  <p>
		  		<form action="insertarnormal.php" method="POST" class="navbar-form navbar-left" role="search">
			...
			<a href="usuarionormal.php" id="noagregar" class="btn btn-default" role="button">No agregar</a>
	  </div>
